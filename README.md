...
```bash
git clone https://github.com/Mixednucolander/duckle-886.git
cd duckle-886
cargo build --release
cargo run
```
...
If you see something not listed, please [open an issue](https://github.com/Mixednucolander/duckle-886/issues) with steps to reproduce + the relevant log line.
...
<!-- Last updated: 2026-06-06 18:41:28 -->
